...
class Courier:
    ...
    def pickUpOrder(self,ready_orders,placed_orders,counter):
        ...
        #Increment counter
        self.counter.increment(courier_wait_time,order_wait_time)


def read_entries(data,index,ready_orders,placed_orders,counter):
    ...
    for i in range(entries_to_read):
        ...
        threading.Timer(travel_time,courier.pickUpOrder, args=(ready_orders,placed_orders,counter,)).start()
    ...
    if index < len(data):
        threading.Timer(1,read_entries, args=(data,index,ready_orders,placed_orders,counter,)).start()
...
def main():
    ...
    read_entries(data,0,ready_orders,placed_orders,counter)
